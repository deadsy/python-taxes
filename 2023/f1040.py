...
class F1040(Form):
    ...
    BRACKET_LIMITS = [
        ...
        [11000, 44725, 95375, 182100, 231250, 346875],  # SEPERATE
    ...
    def __init__(f, inputs={}):
        ...
        if "F8606" in inputs:
            if inputs["status"] == FilingStatus.JOINT:
                f8606 = [f.addForm(F8606(inputs, 0)), f.addForm(F8606(inputs, 1))]
                f["4b"] = (
                    f8606[0]["15c"]
                    + f8606[0]["18"]
                    + f8606[0]["25c"]
        ...
        f["s1_10"] = f.rowsum(
            ["s1_1", "s1_2a", "s1_3", "s1_4", "s1_5", "s1_6", "s1_7", "s1_9"]
        )
        f["8"] = f.get("s1_10")
        ...
        f["s3_14"] = f.rowsum(
            ["s3_13a", "s3_13b", "s3_13c", "s3_13d", "s3_13f", "s3_13h", "s3_13z"]
        )
