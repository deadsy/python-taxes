...
class CA540sca(Form):
    ...
    def __init__(f, inputs, f1040, f1040sa):
        ...
        f["1B_B9a"] = f.rowsum(
            ["1B_B8b", "1B_B8c", "1B_B8f", "1B_B8n", "1B_B8o", "1B_B8p", "1B_B8z"]
        )
        f["1B_C9a"] = f.rowsum(
            ["1B_C8a", "1B_C8c", "1B_C8d", "1B_C8e", "1B_C8k", "1B_C8p", "1B_C8z"]
        )
        f["1B_B10"] = f.rowsum(
            [
                "1A_B1z",
        ...
        f["1B_C10"] = f.rowsum(
            ["1A_C7", "1B_C2a", "1B_C9a", "1A_C1[a-i]", "1A_C[2345]b", "1B_C[3-6]"]
        )

        f["1C_B11"] = f1040.get("s1_11")
        f["1C_B13"] = f1040.get("s1_13")
        f["1C_B26"] = f.rowsum(
            ["1C_B11", "1C_B12", "1C_B13", "1C_B15", "1C_B17", "1C_B20", "1C_B25"]
        )
        f["1C_C26"] = f.rowsum(
            ["1C_C12", "1C_C14", "1C_C19a", "1C_C20", "1C_C21", "1C_C25"]
        )
        ...
        f["2_C17"] = f.rowsum(["2_C4", "2_C7", "2_C10", "2_C14", "2_C15", "2_C16"])
        ...
        if f["1C_B27"] or f["1C_C27"] or f["2_30"] != f.STD_DED[inputs["status"]]:
            f.must_file = True
